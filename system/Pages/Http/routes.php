...
Route::group(['namespace' => 'RadCms\Pages\Http\Controllers', 'middleware' => ['web','auth']], function() {
    ...
    Route::put('admin/pages/{id}/unPublish', ['uses' => 'PageController@unPublish', 'as' => 'pages.unPublish']);
    Route::delete('admin/pages/{id}', ['uses' => 'PageController@destroy', 'as' => 'pages.delete']);
